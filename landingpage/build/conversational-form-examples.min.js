var ConversationalFormExamples = function() {
    function t() {
      this.introTimer = 0, this.hasCalledExamplesInit = !1, this.el = document.querySelector("main.content"), null !== document.getElementById("conversational-form-development") && this.el.classList.add("development"), this.h1writer = new H1WriterExamples({
    ...
    return t.prototype.introFlow1 = function() {
      ...
      this.introTimer = setTimeout(function() {
        t.toggleMenuState(), t.h1writer.start(), t.introTimer = setTimeout(function() {
          document.getElementById("examples-script").getAttribute("manual-init") || t.toggleConversation()
        }, e ? 0 : 2500)
      }, e ? 0 : 500)
      ...
      var t = this;
      return !this.hasCalledExamplesInit && window.initExample && (window.initExample(), this.hasCalledExamplesInit = !0), clearTimeout(this.introTimer), this.el.classList.contains("cf-toggle") ? (this.el.classList.remove("cf-toggle"), window.toggleOff && window.toggleOff()) : (window.toggleOn && window.toggleOn(), setTimeout(function() {
        t.el.classList.remove("menu-toggle"), t.el.classList.add("cf-toggle")
      }, 10)), !1
    }, t.start = function() {
      t.instance || (window.conversationalFormExamples = new t)
    }, t
  }(),
  H1WriterExamples = function() {
    function t(t) {
...
"complete" == document.readyState ? ConversationalFormExamples.start() : window.addEventListener("load", function() {
